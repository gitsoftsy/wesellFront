...
<html>
  ...
  <body>
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/cargo/listarCargos.js?v=<%=(int) (Math.random() * 10000)%>"
    ></script>
    <script
      charset="UTF-8"
