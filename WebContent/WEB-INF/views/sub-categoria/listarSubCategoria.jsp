...
<html>
  ...
  <body>
      ...
      <section class="mb-5">
        <div class="card">
          <div class="card-body title">
            ...
            <span>Lista de Sub-Categorias</span>
          </div>
        </div>
      </section>
      <section class="pt-4 card card-table px-5 py-3">
        ...
        >
          <div class="d-flex gap-4">
            ...
            <a
              href="cadastroDeSubCategoria"
              class="btn botaoCadastro gap-2 d-flex align-items-center justify-content-center"
              ><i class="fa-regular fa-pen-to-square"></i>Nova Sub-Categoria</a
            >
          </div>
          <div class="input-group">
            <input
              ...
              placeholder="Buscar"
            />
            <span class="input-group-text pesquisa-grande icone-pesquisa"
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/subCategoria/listarSubCategoria.js?v=<%=(int) (Math.random() * 10000)%>"
    ></script>
    <script
      charset="UTF-8"
