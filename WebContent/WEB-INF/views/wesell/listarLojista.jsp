...
<html>
  ...
  <body>
      ...
      <section class="mb-5">
        <div class="card">
          <div class="card-body title">
            <i class="fa-solid fa-shop"></i> <span>Lista de Lojistas</span>
          </div>
        </div>
      </section>
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources//assets/js/lojista/listarLojista.js"
    ></script>
    <script
      charset="UTF-8"
