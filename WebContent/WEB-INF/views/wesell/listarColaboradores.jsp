...
<html>
  ...
  <body>
      ...
      <section class="pt-4 card card-table px-5 py-3">
        ...
        >
          <div class="d-flex gap-4">
            ...
            <a
              href="cadastroDeColaboradores"
              class="btn botaoCadastro gap-2 d-flex align-items-center justify-content-center"
              ><i class="fa-regular fa-pen-to-square"></i>Novo Colaborador</a
            >
          </div>
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/colaborador/listarColaboradores.js?v=<%=(int) (Math.random() * 10000)%>"
    ></script>
    <script
      charset="UTF-8"
