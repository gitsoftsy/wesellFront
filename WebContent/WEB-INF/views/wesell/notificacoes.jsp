      ...
      <section class="pt-4 card card-table px-5 py-3">
        ...
        >
          ...
          <tbody id="colaTabela" class="table-group-divider">
          	<tr>
          		<td><button type="button" class="btn btn-status btn-success btn-sm buttonClass" style="width: 63px; height: 31px; padding: 2px; display: flex; align-items: center; justify-content: center;" disabled><i class='fa-solid fa-check fa-xl'></i></button></td>
          		...
          		<td class="d-flex"><span style="width: 63px; margin-right: 5px; height: 31px; padding: 8px; display: flex; align-items: center; justify-content: center;" class="btn btn-primary btn-sm" onclick="editar(this)"><i class="fa-solid fa-file-arrow-down"></i></span> <input type="checkbox" onChange="alteraStatus(this)" checked data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-width="63" class="checkbox-toggle" data-size="sm"></td>
