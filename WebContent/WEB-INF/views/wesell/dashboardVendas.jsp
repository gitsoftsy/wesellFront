...
<link rel="stylesheet"
	href="<%=contextPath%>/resources/assets/css/dashboardVendas.css?v=<%=(int) (Math.random() * 10000)%>" />
</head>
...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-shop"></i> <span>Dashboard de Vendas</span>
				</div>
			</div>
		</section>
		<section class="pt-4 card card-table px-5 py-3">
			<h2 class="title" id="textSemVenda"></h2>
			<div class="d-flex flex-wrap w-100 card-container " id="card-container" style="gap: 1%">
			...
			<div class="row mb-3 card-charts">
			...
			<div id="tabelaTopVendedores"></div>
		</section>
	</main>
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/dashboard/dashboardVendas.js?v=<%=(int) (Math.random() * 10000)%>"></script>
	<script charset="UTF-8"
