...
<html>
  ...
  <body>
    ...
    <button id="btnDesativa" type="button" class="btn botaoDesativaMenu">
    ...
    <main class="py-4 container-res">
      <section class="mb-5">
        <div class="card">
          <div class="card-body title">
            <i class="fa-solid fa-shop"></i> <span>Lista de Banners</span>
          </div>
        </div>
      </section>
      <section class="pt-4 card card-table px-5 py-3">
        ...
        <table
          class="table tabela-itens table-striped table-bordered mb-0 caption-top mx-auto"
        >
          <caption>
            Banners cadastrados
          </caption>
          <thead>
            <tr>
              <th scope="col">Tipo de banner</th>
              <th scope="col">Tipo do dispositivo</th>
              <th scope="col">Local do banner</th>
              <th scope="col">Ordem</th>
              <th scope="col">Url de destino</th>
              <th scope="col">Início da exibição</th>
              <th scope="col">Fim da exibição</th>
