  ...
  <body>
    ...
    <main class="py-4 container-res">
      ...
      <section class="pt-4 card card-table px-5 py-3">
        ...
        >
          <div class="d-flex gap-4">
            ...
            <a
              ...
              ><i class="fa-regular fa-pen-to-square"></i>Novo Funcionário</a
            >
          </div>
        ...
        <table
          class="table tableTel tabela-funcionarios table-striped table-bordered mb-2 caption-top mx-auto"
        >
          <caption>
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/funcionario/listarFuncionarios.js?v=<%=(int) (Math.random() * 10000)%>"
    ></script>
    <script
      charset="UTF-8"
