  ...
  <body>
    ...
    <header class="d-flex flex-column menuPrincipal">
      ...
      >
        <nav class="menu">
          <div class="item">
            <a class="sub-btn d-flex align-items-center ativaSub"
    ...
    <main class="main">
      ...
      <div style="margin-bottom: 35px" class="row">
        ...
        <div class="col-md-3">
          <select id="categoria" class="filtros"></select>
        </div>

        <div class="col-md-3">
          <select id="subCategoria" class="filtros"></select>
        </div>
      </div>
        ...
        <div class="card-group container gap-3 w-100">
          ...
          <div class="card kabum loja Automotivo Pneu col-sm w-25">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                Comissão de até: <span class="spanPreco">R$05,73 </span> Valor
                do Produto: R$49,99
              </p>
              <div class="d-flex gap-2">
                <button
                  type="button"
                  class="btn btn-success botaoCard linkDivulgacao"
                >
                  Link de Divulgação
                </button>
                <input
                ...
                />
                <button type="button" class="btn btn-outline-danger botaoCard">
                  Desativar
                </button>
              </div>
            </div>
          ...
          <div class="card americanas loja col-sm w-25">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                Comissão de até: <span class="spanPreco">R$300,00 </span> Valor
                do Produto: R$5.233,49
              </p>
              <div class="d-flex gap-2">
                <button
                  type="button"
          ...
          <div class="card col-sm combatbrothers loja w-25">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                Comissão de até: <span class="spanPreco">R$05,99 </span> Valor
                do Produto: R$32.94
              </p>
              <div class="d-flex gap-2">
                <button
          ...
          <div class="card col-sm mercadoLivre loja w-25">
            ...
            <div class="card-body">
              <h5 class="card-title">Lubrificante Automotivo</h5>
              <p class="card-text">
                Comissão de até: <span class="spanPreco">R$03,89 </span> Valor
                do Produto: R$32.94
              </p>
              <div class="d-flex gap-2">
                <button
          ...
          <div class="card kabum loja col-sm w-25">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                Comissão de até: <span class="spanPreco">R$03,99 </span> Valor
                do Produto: R$32.94
              </p>
              <div class="d-flex gap-2">
                <button
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/influencer/mercado.js?v=<%=(int) (Math.random() * 10000)%>"
    ></script>
  </body>
</html>
