...
<body>
	...
	<main class="py-4 container-res">
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-user-pen fa-lg"></i> <span id="tituloPagina">Editar
						Influencer</span>
				</div>
			</div>
		</section>
		<section class="pt-4">
			<form id="form-funcionario"
				...
				<h1 id="tituloForm" class="text-center mb-5">Editar</h1>
				...
				<div class="row mb-2">
					...
					<div class="col-md-6">
						<label for="dtNasc" class="form-label">Data
							de nascimento:<span class="red">*</span>
						</label> <input required autocomplete="off" type="date" id="dtNasc"
							name="dtNasc" class="form-control inputForm" />
					</div>
				</div>
				...
				<div class="row mb-2">
					...
					<div class="col-md-6" id="cardCPF">
						<label for="cpf" class="form-label">CPF:<span
							class="red">*</span></label> <input type="text" id="cpf" required
							autocomplete="off" name="cpf" class="form-control inputForm"
							data-mask="000.000.000-00" maxlength="11" />
					</div>
					<div class="col-md-6" id="cardCNPJ">
						<label for="cnpj" class="form-label">CNPJ:<span
							class="red">*</span></label> <input type="text" id="cnpj" required
							autocomplete="off" name="cnpj" class="form-control inputForm"
							data-mask="00.000.000/0000-00" maxlength="17" />
					</div>
				</div>
				...
				<div class="row mb-2">
					<div class="col-md-6">
						<label for="celular" class="form-label">Celular:<span
							class="red">*</span></label> <input type="text" id="celular" required
							autocomplete="off" name="celular" class="form-control inputForm"
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/influencer/editarInfluencer.js"></script>
</body>
</html>
