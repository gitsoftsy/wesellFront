...
<html>
  ...
  <body>
          ...
          <div class="row">
            <div class="col-md-12">
              <img
                class="logoInf"
                width="25%"
                src="resources/assets/img/logo.svg"
                alt="logo"
              />
              <h1 class="h1Inf">
              ...
              <p>
                Vamos te ajudar desde os primeiros passos.<br />
                Cadastre-se grátis.
              </p>
            </div>
          </div>
      ...
      <section class="pt-5 bg-light bg-gradient segundaSection h-100 main">
        ...
        >
          <div class="col-md-8 mb-4 d-flex flex-column container text-center">
            <label for="rede" class="form-label"
              >Qual a sua rede social principal?<span class="red"
                >*</span
              ></label
            >
            <select
          ...
          <div
            class="col-md-8 mb-4 d-flex gap-2 flex-column container text-center"
          >
            <label for="usuario" class="form-label"
              >Qual seu nome de usuário nesta rede?<span class="red"
                >*</span
              ></label
            >
            <input
          ...
          <div class="col-md-8 mb-4 d-flex flex-column container text-center">
            <label for="seguidores" class="form-label"
              >Quantos seguidores você possui nesta rede?<span class="red"
                >*</span
              ></label
            >
            <select
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/influencer/perguntaInfluencer.js?v=<%=(int) (Math.random() * 10000)%>"
    ></script>
  </body>
</html>
