...
<html>
  ...
  <body>
      ...
      <section class="pt-4 card card-table px-5 py-3">
        ...
        >
          <div class="d-flex gap-4">
            ...
            <a
              href="cadastroDeCategoria"
              class="btn botaoCadastro gap-2 d-flex align-items-center justify-content-center"
              ><i class="fa-regular fa-pen-to-square"></i>Nova Categoria</a
            >
          </div>
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/categoria/listarCategoria.js?v=<%=(int) (Math.random() * 10000)%>"
    ></script>
    <script
      charset="UTF-8"
