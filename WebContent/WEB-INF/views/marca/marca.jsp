				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="marca" class="form-label">Nome da marca:<span
									class="red">*</span>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							<div class="mb-4">
								<label for="marcaEdit" class="form-label">Nome da marca:<span class="red">*</span>
								</label> <input type="text" id="marcaEdit" required
									autocomplete="off" name="marcaEdit"
									class="form-control" />
							</div>
							<div class="d-flex justify-content-end gap-2">
								<button type="button" class="btn btn-secondary"
