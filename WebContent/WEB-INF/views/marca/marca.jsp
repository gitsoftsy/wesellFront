...
<body>
			...
			<div class="mt-3 mb-2"
				...
				<div class="d-flex gap-4">
					...
					<!-- <a href="cadastroDeCargo"
						...
						class="fa-regular fa-pen-to-square"></i>Nova Marca</a> -->
					<button
						class="btn botaoCadastro gap-2 d-flex align-items-center justify-content-center"
			...
			<table
				...
				<thead>
					<tr>
						...
						<th scope="col" width="100%">Marcas</th>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="marca" class="form-label">Nome
									da marca:<span class="red">*</span>
								</label> <input type="text" id="marca" required autocomplete="off"
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							<div class="mb-4">
								<label for="marcaEdit" class="form-label">Nome
									da marca:<span class="red">*</span>
								</label> <input type="text" id="marcaEdit" required autocomplete="off"
									name="marcaEdit" class="form-control" />
							</div>
							<div class="d-flex justify-content-end gap-2">
								<button type="button" class="btn btn-secondary"
									data-bs-dismiss="modal">Fechar</button>
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources//assets/js/marca/marca.js"></script>
	<script charset="UTF-8"
