...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="<%=contextPath%>/resources/assets/css/dashboardVendasLojista.css?v=<%=(int) (Math.random() * 10000)%>"
    />
  </head>
  ...
  <body>
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/dashboard/dashboardVendasLojista.js?v=<%=(int) (Math.random() * 10000)%>"
    ></script>
    <script
      charset="UTF-8"
