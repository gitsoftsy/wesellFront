...
<html>
  ...
  <body>
    ...
    <div class="fundoBranco">
      <h3 class="text-center tituloPrincipal">
        Vamos começar a cadastrar sua Loja
      </h3>
        ...
        >
          ...
          <div class="row mb-2">
            <div class="col-md-12 text-center">
              ...
              <span
                id="prosseguir"
                class="btn confirm btn-success btn-register d-none"
                >Prosseguir</span
              >
            </div>
          </div>
