...
<html>
  ...
  <body>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="formCadastro">
              ...
              <div class="mb-4">
                <label for="tipoTelefone" class="form-label"
                  >Tipo de telefone:<span class="red">*</span>
                </label>
                <select
                  id="tipoTelefone"
                  required
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="formEdit">
              ...
              <div class="mb-4">
                <label for="tipoTelefoneEdit" class="form-label"
                  >Tipo de telefone:<span class="red">*</span>
                </label>
                <select
                  id="tipoTelefoneEdit"
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/lojista/listarTelefoneLojista.js?v=<%=(int)(Math.random()*10000)%>"
    ></script>
