...
<html>
  ...
  <body>
          ...
          <div class="row mb-2" id="area-input-edit" hidden>
            <div class="col-md-12">
              <label for="nomeProdutoEdit" class="form-label"
                >Nome do produto:<span class="red">*</span>
              </label>
              <input
                type="text"
                id="nomeProdutoEdit"
          ...
          <div class="row mb-2" id="area-input-cadastro">
            ...
            <div id="boxImg" class="col-md-6">
              <label for="file" class="form-label"
                >Imagens do Produto:<span class="red">*</span>
              </label>
              <input
                autocomplete="off"
                type="file"
          ...
          <div class="row mb-2">
            <div class="col-md-6" id="cardPrecoDeVenda">
              <label for="precoDeVenda" class="form-label"
                >Preço de venda:<span class="red">*</span>
              </label>
              <input
                type="tel"
                id="precoDeVenda"
            ...
            <div class="col-md-6" id="cardPrecoPromocional">
              <label for="precoPromocional" class="form-label"
                >Preço promocional:<span class="red">*</span>
              </label>
              <input
                type="tel"
                id="precoPromocional"
          ...
          <div class="row mb-2">
            ...
            <div class="col-md-6">
              <label for="marca" class="form-label"
                >Marca: <span class="red">*</span></label
              >
          ...
          <div class="row mb-2 dimensoes">
            <div class="col-md-6">
              <label for="largura" class="form-label"
                >Largura (cm):<span class="red">*</span>
              </label>
              <input
                autocomplete="off"
                type="number"
          ...
          <div class="row mb-3 dimensoes">
            <div class="col-md-6">
              <label for="profundidade" class="form-label"
                >Profundidade (cm):<span class="red">*</span>
              </label>
              <input
                autocomplete="off"
                type="number"
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/lojista/cadastroProdutoLojista.js?v=<%=(int) (Math.random() * 10000)%>"
    ></script>
