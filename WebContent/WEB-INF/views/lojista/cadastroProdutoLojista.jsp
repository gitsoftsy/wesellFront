		...
		<section class="pt-4">
			<form id="form-cadastro"
				...
				<div class="row mb-2">
					<div class="col-md-6">
						<label for="precoDeVenda" class="form-label">Preço de
							...
							name="precoDeVenda" class="form-control inputForm" maxlength="12" />
					</div>
					<div class="col-md-6">
						<label for="precoPromocional" class="form-label">Preço
							...
							autocomplete="off" name="precoPromocional"
				...
				<div class="row mb-2">
					<div class="col-md-6">
						<label for="comissao" class="form-label">Comissão:<span
							...
							type="tel" id="comissao" name="comissao"
							class="form-control inputForm" maxlength="12" />
					</div>
					<div class="col-md-6">
				...
				<div class="row mb-2">
					...
					<div class="col-md-6">
						<label for="marca" class="form-label">Marca: <span class="red">*</span></label> <select
