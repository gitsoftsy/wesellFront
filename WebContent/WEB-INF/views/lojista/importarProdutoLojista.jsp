...
<html>
  ...
  <body>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6">
              <label for="modelo" class="form-label"
                >Baixe o modelo de arquivo a ser preenchido:</label
              >
              <button
                id="btnDownload"
                type="button"
                style="width: 100%"
                class="btn btn-secondary form-input gap-2 d-flex align-items-center justify-content-center"
              >
            ...
            <div class="col-md-6">
              <label for="fileExcel" class="form-label"
                >Importar arquivo:<span class="red">*</span>
              </label>
              <input
                class="form-control"
                required
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/lojista/importarProdutoLojista.js?v=<%=(int) (Math.random() * 10000)%>"
    ></script>
    <script
      charset="UTF-8"
