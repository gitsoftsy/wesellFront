...
<body>
	...
	<main class="py-4 container-res">
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-regular fa-bell fa-lg"></i> <span>Lista de
						Notificações</span>
				</div>
			</div>
		</section>
		<section class="pt-4 card card-table px-5 py-3">
			...
			<table
				...
				<caption>Notificações Cadastradas</caption>
				<thead>
					<tr>
				...
				<tbody id="colaTabela" class="table-group-divider">
					<tr>
						...
						<td><button type="button"
								...
								style="width: 63px; height: 31px; padding: 2px; display: flex; align-items: center; justify-content: center;"
								disabled>
								<i class='fa-solid fa-check fa-xl'></i> <!-- xmark -->
							</button></td>
						<td>Graduação</td>
						<td>Gestão</td>
						...
						<td class="d-flex"><span
							style="width: 60%; margin-right: 5px; height: 31px; padding: 8px; display: flex; gap: 6px; align-items: center; justify-content: center;"
							class="btn btn-primary btn-sm" onclick="editar(this)">Baixar
						</span></td>
					</tr>
				</tbody>
			</table>
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources//assets/js/notificacoes/notificacoesLojista.js"></script>
	<script charset="UTF-8"
