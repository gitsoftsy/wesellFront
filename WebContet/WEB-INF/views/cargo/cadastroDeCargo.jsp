	...
	<main class="py-4 container-res">
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-regular fa-address-card"></i> <span>Cadastro
						de Cargo</span>
				</div>
			</div>
		</section>
		<section class="pt-4">
			<form id="form-funcionario" 
				...
				<h1 class="text-center mb-5">Cadastrar Cargo</h1>
				...
				<div class="row mb-2">
					...
					<div class="col-md-6">
						<label for="descricao" class="form-label">Descrição:</label> <input
							type="text" id="descricao" required autocomplete="off" name="descricao"
